...
- **`hu.blackbelt.base`**: Reusable components and base classes for all features
...
- **`hu.blackbelt.examplefeature`**: Example feature demonstrating the structure
...
1. Create a new package under `hu.blackbelt` (e.g., `hu.blackbelt.myfeature`)
